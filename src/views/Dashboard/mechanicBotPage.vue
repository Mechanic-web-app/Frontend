					...
					<b-col cols="12" md="8" class="qaCol">
						<div v-if="!isStarted">
							<h1>
								...
								Jeśli chcesz zacząć diagnostykę swojego
								samochodu naciśnij przycisk start
							</h1>
							<b-button
								pill
								variant="light"
						...
						<div v-if="q25 == false">
							<h1>
								Naładuj lub wymień akumulator i spróbuj
								ponownie.
							</h1>
						</div>
						...
						<div v-if="q25 && q26 == null">
							<h1>
								4. Czy deska rozdzielcza reaguje na przekręcenie
								kluczyka w pozycję zapłonu?
							</h1>
							<b-button
								pill
								variant="light"
						...
						<div v-if="q26">
							<h1>
								...
								- Awaria rozrusznika - Uszkodzenie instalacji
								elektrycznej
							</h1>
						</div>
						<div v-if="q26 == false">
							<h1>
								...
								- Uszkodzenie lub zwarcie w instalacji
								elektyrycznej <br />
								- Uszkodzona stacyjka
							</h1>
						</div>
						...
						<div v-if="q4 && q4 !== null">
							<h1>
								W takim przypadku liczba możliwych usterek jest
								zbyt duża. Zapraszamy na wizytę w celu
						...
						<div v-if="q10 && q10 !== null">
							<h1>
								...
								- Niski poziom płynu hamulcowego - Awaria
								sterownika silnika
							</h1>
						</div>
						<div v-if="q22 == false && q23 == null">
							<h1>
								5. Czy po przekręceniu stacyjki w pozycję
								zapłonu słychać pracę pompy paliwa?
							</h1>
							<b-button
								pill
								variant="light"
						...
						<div v-if="q18 && q19 == null">
							<h1>
								5. Czy drgania występują powyżej określonej
								prędkości?
							</h1>
							<b-button
								pill
						...
						<div v-if="q19 == false && q19 !== null">
							<h1>
								Jeśli drgania występują podczas hamowania,
								prawdopodobne usterki to:<br /><br />
						...
						<div v-if="q10 == false && q11 == null">
							<h1>
								5. Czy wyświetlany jest błąd niskiego poziomu
								oleju?
							</h1>
							<b-button
								pill
						...
						<div v-if="q23 && q24 == null">
							<h1>
								6. Czy przy próbie odpalenia samochodu drga
								wskazówka obrotomierza?
							</h1>
							<b-button
								pill
								variant="light"
						...
						<div v-if="q11 == false && q12 == null">
							<h1>
								6. Czy wyświetlany jest błąd wysokiej
						...
						<div v-if="q12 == false && q12 !== null">
							<h1>
								<h1>
									Jeśli wyświetlany jest błąd wspomagania
									kierownicy prawdopodobne usterki to:<br /><br />
						...
						<div v-if="q16 == false">
							<h1>
								<h1>
									Jeśli spod maski dochodzi dźwięk stukania
									prawdopodobne usterki to:<br /><br />
						...
						<div v-if="q5 == false && q6 == null">
							<h1>
								6. Czy samochód poszarpuje podczas jazdy lub na
								biegu jałowym?
							</h1>
							<b-button
								pill
						...
						<div v-if="q6 && q6 !== null">
							<h1>
								...
								<br />
								- Uszkodzona listwa wtryskiwaczy lub
								pompowtryskiwaczy <br />
								- Zapchany lub uszkodzony układ wydechowy
							</h1>
						</div>
						<div v-if="q6 == false && q7 == null">
							<h1>
								7. Czy z układu wydechowego wydobywa się dym?
							</h1>
							<b-button
								pill
								variant="light"
						...
						<div v-if="q17 && q17 !== null">
							<h1>
								...
								Możliwe jest również szumienie opon, co nie
								powinno być powodem do obaw
							</h1>
						</div>
						<div v-if="q17 == false && q17 !== null">
							<h1>
								Jeśli szum wydobywa się spod maski prawdopodobne
								usterki to:<br /><br />
						...
						<div v-if="q9 == false && q9 !== null">
							<h1>
								Jeśli z twojego układu wydechowego wydobywa się
								czarny dym, prawdopodobne usterki to:<br /><br />
