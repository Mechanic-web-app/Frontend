  ...
  <div>
    ...
    <div>
      <b-carousel
        ...
        img-height="750"
      >
        <b-carousel-slide class="firstSlide" img-src="https://i.imgur.com/xAvDptg.jpg">
          <h1>Witaj na stronie warsztatu BNS</h1>
          <h2>Sprawdź wykonywane przez nas usługi</h2>
          <b-button variant="primary">USŁUGI</b-button>
        </b-carousel-slide>
        <b-carousel-slide class="secondSlide" img-src="https://i.imgur.com/aIMASFv.jpg">
          <h1>Umów się na wizytę</h1>
          <h2>Za pomocą naszego czatu on-line dostępnego w godzinach 8-16</h2>
          <b-button variant="primary">CZAT</b-button>
        </b-carousel-slide>
        <b-carousel-slide class="thirdSlide" img-src="https://i.imgur.com/6I0oLva.jpg">
          <h1>Zdiagnozuj swoją usterkę</h1>
          <h2>Za pomocą naszego BOTA</h2>
          <b-button variant="primary">BOT</b-button>
        </b-carousel-slide>
      </b-carousel>
    </div>
    <div class="second">
      <div>
        <b-jumbotron bg-variant="primary" text-variant="white" border-variant="dark">
          ...
          <h2>
            Co przekłada się na tysiące zadowolonych klientów. Zostań jednym z nich!
          </h2>

          <hr class="my-4" />

          <p>
            Naciśnij przycisk, jeśli chcesz się o nas dowiedzieć więcej i przeczytać
            opinie.
          </p>
    ...
    <GmapMap
      :center="center"
      :zoom="12"
      style="width: 100%; height: 60vh; margin-top: 10vh"
      ><GmapMarker
...
export default {
  data() {
    return {
      center: { lat: 51.41785, lng: 16.19511 },
      lat: 51.41785,
      lng: 16.19511,
    };
  },
